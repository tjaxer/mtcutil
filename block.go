...
// Tx returns a wrapped transaction (mtcutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (mtcutil.Tx) for all
...
// instead provides easy access to wrapped versions (mtcutil.Tx) of them.
