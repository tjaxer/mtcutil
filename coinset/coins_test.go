...
func NewCoin(index int64, value mtcutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = mtcutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = mtcutil.NewTxFromBytes(testSimpleCoinTxBytes)
